	...
	return(
		...
		">
			<div className="overflow-hidden flex-1 relative">
				...
				<Link to={props.createLink(country.cca3)} tabIndex="-1" className="w-full h-full inline-block flex items-center justify-center group relative z-10">
			...
			<div className="px-6 pt-6 flex-1">
				<h2 className="mb-4 font-bold text-base">
					<Link to={props.createLink(country.cca3)}>
						{country.name.common}
					</Link>
				</h2>
