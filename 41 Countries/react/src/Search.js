        ...
        return (
            <div className=" m-auto">
                ...
                >
                    ...
                    <button onClick={this.shuffle} className="hover:bg-grey-300 mb-3 lg:mb-0 md:mr-4 md:ml-auto flex items-center justify-center bg-lightElements dark:bg-darkElements h-12 w-12 text-lightText dark:text-darkText rounded-md shadow-lg  hover:brightness-125 transition-all">
    ...
    render() {
        return (
            <div className="bg-lightElements mb-3 lg:mb-0  dark:bg-darkElements h-12 w-48 text-lightText dark:text-darkText rounded-md shadow-lg relative">
                ...
                <button className="bg-lightElements dark:bg-darkElements h-full ml-auto w-full rounded-md flex items-center justify-between px-6 relative z-20  hover:brightness-125 transition-all"
                    aria-expanded="false"
