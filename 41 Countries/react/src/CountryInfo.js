	...
	return (
		<div className="max-w-[95rem] m-auto">
			<div className="info-links mb-8 sm:mb-12 md:mb-14 flex items-center justify-between">
				<Link to={"/"} className="hover:bg-gray-200 dark:hover:brightness-125 transition-all shadow-lg bg-lightElements dark:bg-darkElements flex items-center justify-between px-4 py-1 rounded-md shadow-lg">
...
function BorderCountry(props) {
	...
	return (
		<Link to={props.to} className="inline-block min-w-[100px] shadow-lg rounded-sm bg-lightElements dark:bg-darkElements text-center text-sm py-1 px-2 hover:bg-gray-200 dark:hover:brightness-125 transition-all">
			{props.name}
		</Link>
		);
}
